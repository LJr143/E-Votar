...
<div class="flex w-full overflow-hidden">
    <div class="flex relative w-1/2 ">
        <input type="text" placeholder="Search here" class="w-full h-[25px] pl-2 pr-8 text-gray-500 text-[12px] py-4 rounded border-gray-100 focus:outline-none focus:border-transparent">
