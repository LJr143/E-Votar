                    ...
                    <div class="flex items-center space-x-1 ">
                        ...
                        <a href="
                           ...
                           class="text-[12px] font-normal text-[#757575]
                            {{ request()->routeIs('admin.dashboard') || request()->routeIs('technical.dashboard') ? 'text-white' : 'group-hover:text-white' }}">
                            Dashboard
                        </a>
                            ...
                            <li>
                                <a href="{{ auth()->user()->hasAnyRole($rolesExceptVoter) ? route('admin.candidates') : '#' }}"
                                   class="flex items-center block px-3 py-2 text-[11px] transition duration-200 rounded-md
                                    ...
                                    <!-- SVG Icon -->
                                    <svg class="icon mr-3" width="16" height="16" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a href="{{ auth()->user()->hasAnyRole($rolesExceptVoter) ? route('admin.positions') : '#' }}"
                                   class="flex items-center block px-3 py-2 text-[11px] transition duration-200 rounded-md
                                    ...
                                    <!-- SVG Icon -->
                                    <svg class="icon mr-2" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="M624-384q-50 0-85-35t-35-85q0-50 35-85t85-35q50 0 85 35t35 85q0 50-35 85t-85 35ZM384-144v-63q0-28 14.5-51t38.5-35q43-21 90-32t97-11q50 0 97 11t90 32q24 12 38.5 35t14.5 51v63H384Zm73-72h334q-30-23-72-35.5T624-264q-53 0-95 12.5T457-216Zm167-240q20.4 0 34.2-13.8Q672-483.6 672-504q0-20.4-13.8-34.2Q644.4-552 624-552q-20.4 0-34.2 13.8Q576-524.4 576-504q0 20.4 13.8 34.2Q603.6-456 624-456Zm0-48Zm0 288ZM144-396v-72h288v72H144Zm0-300v-72h432v72H144Zm293 150H144v-72h326q-12 16-20.11 33.78Q441.77-566.44 437-546Z"/></svg>
                                    <!-- Text -->
                                    Position
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ auth()->user()->hasAnyRole($rolesExceptVoter) ? route('admin.vote.tally') : '#' }}"
                                   class="flex items-center block px-3 py-2 text-[11px] transition duration-200 rounded-md
                                    ...
                                    <!-- SVG Icon -->
                                    <svg class="icon mr-2" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="M624-192v-288h144v288H624Zm-216 0v-576h144v576H408Zm-216 0v-384h144v384H192Z"/></svg>
                        ...
                        <li>
                            <a href="{{ auth()->user()->hasAnyRole($rolesExceptVoter) ? route('admin.college') : '#' }}"
                               class="flex items-center block px-3 py-2 text-[11px] transition duration-200 rounded-md
                                ...
                                <!-- SVG Icon -->
                                <svg class="icon mr-2" fill="currentColor" height="16" width="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 325.262 325.262" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                            ...
                            <li>
                                <a href="{{ auth()->user()->hasAnyRole($rolesExceptVoter) ? route('admin.feedback') : '#' }}"
                                   class="flex items-center block px-3 py-2 text-[11px] transition duration-200 rounded-md
                                    ...
                                    <!-- SVG Icon -->
                                    <svg class="icon mr-2" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="M479.79-360q15.21 0 25.71-10.29t10.5-25.5q0-15.21-10.29-25.71t-25.5-10.5q-15.21 0-25.71 10.29t-10.5 25.5q0 15.21 10.29 25.71t25.5 10.5ZM444-480h72v-264h-72v264ZM96-96v-696q0-29.7 21.15-50.85Q138.3-864 168-864h624q29.7 0 50.85 21.15Q864-821.7 864-792v480q0 29.7-21.15 50.85Q821.7-240 792-240H240L96-96Zm114-216h582v-480H168v522l42-42Zm-42 0v-480 480Z"/></svg>
