...
<x-guest-layout>
    ...
    <div class="bg-white py-0 pt-0 flex justify-center items-center w-full">
        <div class="w-full">
            ...
            <h2 class="text-[24px] sm:text-[28px] md:text-[30px] text-primary text-black font-semibold text-center mt-5">
                ACCOUNT REGISTRATION
                <h3 class="text-[10px] sm:text-[12px] md:text-[14px] text-primary font-light text-black mb-3 text-center capitalize">
            ...
            <div>
                    <form action="{{route('admin.unregistered.admin.post')}}" method="POST" class="">
                        @csrf
                        ...
                        <div class="w-full flex flex-col sm:flex-row justify-between mt-4 space-y-2 sm:space-y-0 sm:space-x-4">
                            ...
                            <a href="{{ route('admin.system.user') }}"
                               class="uppercase font-bold bg-gray-300 w-full sm:w-1/5 text-[14px] text-black rounded p-2 hover:bg-gray-200 transition duration-200 text-center">
                                Cancel
                            </a>

                            <!-- Other Buttons -->
                            <div class="flex space-x-4 w-full sm:w-1/5">
                                <button type="submit"
