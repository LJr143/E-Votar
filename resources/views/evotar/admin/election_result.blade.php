<x-app-layout mainClass="flex" page_title="- Election Result">
    ...
    <x-slot name="main">
        <div class="bg-transparent px-2 py-0 min-h-screen ">
            ...
            <div class="bg-white p-6 text-[11px] md:text-[12px] mt-4 shadow-md rounded">
                <div class=" mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row">
                            ...
                            <div class="overflow-x-auto min-h-[350px]">
                                <table class="min-w-full ">
                                    ...
                                    <tr class="border-b border-gray-100  ">
                                        ...
                                        <td class="py-3 px-8 text-left font-bold">Brooklyn Simmons</td>
                                    ...
                                    <tr class="border-b border-gray-100 ">
                                        <td class="py-3 px-6 text-left">Internal Vice President</td>
                                        <td class="py-3 px-8 text-left font-bold">Joe Simmons</td>
                                        <td class="py-3 px-6 text-left">Yanong Agila</td>
                                        <td class="py-3 px-6 text-left">17 votes</td>
                                        <td class="py-3 px-6 text-left">
                                            <div class="font-bold">57 votes</div>
                                    ...
                                    <tr class="border-b border-gray-100 ">
                                        <td class="py-3 px-6 text-left">External Vice President</td>
                                        <td class="py-3 px-8 text-left font-bold">John Simmons</td>
                                        <td class="py-3 px-6 text-left">Yanong Agila</td>
                                        <td class="py-3 px-6 text-left">17 votes</td>
                                        <td class="py-3 px-6 text-left">
                                            <div class="font-bold">57 votes</div>
                        ...
                        <div class="w-full md:w-1/4 md:ml-4 mt-8 md:mt-0">
                            <div class="bg-gray-100 text-black uppercase text-[11px] leading-normal text-center font-bold py-2 border-b border-gray-300 rounded-t-lg">
                                TAGUM STUDENT COUNCIL ELECTION
                            </div>
                            <table class="w-full border-collapse border-t border-b border-gray-100 rounded-t-lg">
                                ...
                                <tr class="bg-white border-b border-gray-100 py-3 px-6 text-left">
                                    ...
                                    <td class="py-3 px-6 border-t border-b border-gray-100">94.339%</td>
                                </tr>
                                <tr>
                                    <td class="py-3 px-6 border-t border-b border-gray-100">Voters Who Actually Voted</td>
                                    <td class="py-3 px-6 border-t border-b border-gray-100">50</td>
                                </tr>
                                <tr class="bg-white">
                                    <td class="py-3 px-6 border-t border-b border-gray-100">Voters Who Did Not Vote</td>
                                    <td class="py-3 px-6 border-t border-b border-gray-100">3</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
