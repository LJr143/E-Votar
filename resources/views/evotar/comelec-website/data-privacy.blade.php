        ...
        <main>
            ...
            <div class="py-12 ">
                <div class="container mx-auto text-justify px-10">
                    ...
                    <p class="text-gray-600 text-sm mb-4">For a comprehensive and detailed view of the University’s data privacy policies, please refer to the *University’s Data Privacy Manual.</p>
                    <p class="text-black font-semibold text-sm  mb-4">What personal data the University may collect and process?</p>
                    <p class="text-gray-600 text-sm  mb-4">The University collects and processes only the type and amount of data necessary to perform its core and auxiliary functions. As an institution composed of heterogeneous entities, the University may collect a variety of personal information in different contexts and for different specific purposes.</p>
                    <p class="text-gray-600 text-sm  mb-4">In general, among the common personal data the University may collect include:</p>
                    <ul class="text-gray-600 text-sm list-disc ml-12 mb-4">
                                <li>Name</li>
                    ...
                    <p class="text-gray-600 text-sm  mb-4">All personal data collection and processing can only be done when the University acquires the consent of the data subject, either explicitly or implicitly, after the latter has been informed of the nature and extent of data collection and processing.</p>
                    <p class="text-black font-semibold text-sm  mb-4">Why does the University collect and process personal data?</p>
                    <p class="text-gray-600 text-sm  mb-4">The purpose of personal data collection and processing may vary from one University procedure (e.g. student admission, visitor entry, human resource management, etc.) to another. However, the general principle governing the University’s data collection process is legitimacy of purpose.</p>
                    <p class="text-gray-600 text-sm  mb-4">The University shall only collect and process data for legitimate purposes in consonance with its inherent functions and in compliance with legal requirements. These legitimate purposes may include, but may not be limited to, the following:</p>
                    <ul class="text-gray-600 text-sm list-disc ml-12 mb-4">
                    ...
                    <p class="text-black font-semibold text-sm  mb-4">How does the University share or disclose personal data?</p>
                    ...
                    <p class="text-gray-600 text-sm mb-4">Internal disclosure of personal data from one University entity to another shall be subjected to an institutionalized standard data request procedure. This ensures that data is transmitted through official channels and shared for legitimate purposes.</p>
                    <p class="text-gray-600 text-sm  mb-4">Regardless of the context of data disclosure, the University shall always practice the principle of data minimization which means that only the minimum amount of data needed to serve a particular purpose is shared to the requesting entity.</p>

                    <p class="text-black font-semibold text-sm  mb-4">How does the University protect personal data?</p>
                    ...
                    <p class="text-black font-semibold text-sm mb-4">How long does the University retain personal data?</p>
                    ...
                    <p class="text-gray-600 text-sm  mb-4">For concerns and inquiries relating to the University Data Privacy, please don't hesitate to contact the University Data Privacy Officer, Ms. Dessa L. Caballero of the University Data Privacy Office (UDPO) through this email: ola-udpo@usep.edu.ph.</p>
