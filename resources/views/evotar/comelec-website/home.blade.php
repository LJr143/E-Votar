<x-custom-layout>
    ...
    <x-slot name="main">
        ...
        <div class="relative">
            ...
            <div class="absolute top-0 right-0 mt-4 mr-4 w-1/5"> <!-- Responsive width -->
                <label class="block text-sm font-medium text-white" for="election-filter">Select Election</label>
                <select class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-black focus:border-black sm:text-sm rounded-md" id="election-filter" name="election-filter" onchange="updateContent()">
                    <option value="election1">Tagum Student Council and Local Council Election 2025</option>
                    <option value="election2">Tagum Student Council Election 2025</option>
                    <option value="election3">Local Council Election 2025</option>
                </select>
            </div>
            <div class="absolute bottom-0 left-0 right-0 p-2 flex justify-center" style="transform: translateY(50%);">
                <div class="rounded-lg shadow-lg p-4 flex flex-col items-center w-full max-w-2xl" style="background: rgba(255, 255, 255, 0.8); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.3);">
                    <h2 class="text-center text-gray-800 font-semibold text-lg">Tagum Student Council and Local Council Election 2025</h2>
                    <h2 class="text-center text-gray-800 font-semibold mb-2 text-lg">ends in</h2>
