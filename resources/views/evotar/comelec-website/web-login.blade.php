...
<div x-data="{ open: false }" x-cloak @election-created.window="open = false">
    ...
    <button @click="open = true"
            class="w-[120px] h-8 rounded bg-black text-white text-[12px] flex items-center justify-center gap-2 hover:bg-gray-700">
                                ...
                                <div class="flex flex-col md:flex-row md:space-x-4 mb-4 border border-gray-300 rounded-md p-4">
                                    <div class="flex-1 mb-3 md:mb-0">
                                        ...
                                        <input id="election_start" type="datetime-local"
                                               class="border border-gray-300 text-xs rounded-md px-4 py-2 w-full focus:ring focus:ring-black focus:outline-none"
                            ...
                            <div class="flex-col h-[355px] w-full md:w-1/2  overflow-auto">
                                <div class="mb-4">
                                    ...
                                    @if(!empty($studentCouncilPositions))
                                        <p class="text-[10px] font-normal text-center mt-4 sm:mt-2 mb-2">Student Council Positions</p>
                                    ...
                                    @if(!empty($localCouncilPositions) && $election_type != 2)
                                        <p class="text-[10px] font-normal text-center mb-2 mt-4">Local Council Positions</p>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
