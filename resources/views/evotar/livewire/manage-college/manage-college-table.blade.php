                    ...
                    <div class="flex flex-col md:flex-row w-full items-center justify-between">
                        <div class="flex items-center justify-between flex-wrap md:flex-nowrap gap-2">
                            <button
                                ...
                                wire:click="exportColleges"
                                wire:loading.attr="disabled">
                                <svg wire:loading.remove wire:target="exportColleges" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960"
                                ...
                                <span wire:loading.remove wire:target="exportColleges" class="text-[12px]">Export List of Colleges</span>
                                <svg wire:loading wire:target="exportColleges" class="animate-spin h-5 w-5 mr-3" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                            stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor"
                                          d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span wire:loading wire:target="exportColleges">Exporting...</span>
                            </button>
                        </div>
