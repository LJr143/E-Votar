<div x-data="{ open: false }" x-cloak @college-deleted.window="open = false">
    <!-- Trigger Button -->
        ...
        >
            ...
            <div class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    ...
                    <h2 class="text-sm font-semibold text-red-600">Delete College</h2>
                </div>
                <!-- Close Button (X) -->
            ...
            <form wire:submit.prevent="delete">
                <div>
                    <p class="text-gray-700 mb-6 ml-5 text-xs text-left">Are you sure you want to remove this college? This process cannot be undone.</p>
                    <p class="text-gray-500 mb-2 ml-5 font-bold italic text-xs text-left">{{ $college->name }}</p>
