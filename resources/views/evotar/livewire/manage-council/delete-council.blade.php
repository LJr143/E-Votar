<div x-data="{ open: false }" x-cloak @council-deleted.window="open = false">
    ...
    >
        ...
        >
            ...
            @endif
            <p class="text-gray-700 mb-6 ml-5 text-xs text-left">Are you sure you want to remove this council? This process cannot be undone <strong>{{ $council->name }}</strong>.</p>
            <form wire:submit.prevent="deleteCouncil">
                <div>
                    <x-input
                        type="password"
