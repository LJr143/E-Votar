<div x-data="{ open: false }" x-cloak @council-deleted.window="open = false">
    <!-- Trigger Button -->
        ...
        >
            ...
            <div class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    ...
                    <h2 class="text-sm font-semibold text-red-600">Delete Council</h2>
                </div>
                <!-- Close Button (X) -->
                ...
                <div>
                    <p class="text-xs text-left text-gray-600 mb-4">Are you sure you want to delete this council and all its position settings? This action cannot be undone.</p>
                    ...
                    <div class="flex justify-end mt-4 space-x-2">
                        ...
                        <button wire:click="deleteCouncil"
                                wire:loading.attr="disabled"
                                class="px-4 py-2 bg-red-600 text-white text-sm rounded-md hover:bg-red-700 hover:drop-shadow  hover:scale-105 hover:ease-in-out hover:duration-300 transition-all duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:-translate-y-1 active:scale-x-90 active:scale-y-110">
