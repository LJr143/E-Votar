                    ...
                    <div class="mt-6 min-h-[400px] overflow-x-auto" x-data="{
                                        ...
                                        <div class="flex -space-x-2" wire:key="members-{{$party_list->id}}">
                                            ...
                                            @foreach($party_list->candidates->take($maxDisplay) as $candidate)
                                                <img
                                                    ...
                                                    src="{{ $candidate->users->profile_photo_path ? asset('storage/' . $candidate->users->profile_photo_path) : asset('storage/assets/profile/vargas.png') }}"
                                                    width="24"
                                                    height="24"
                                                />
                                            @endforeach
                        ...
                        @if ($party_lists->isEmpty())
                            <div class="border border-gray-200 rounded-md p-8 text-center">
                                ...
                                <h3 class="text-[14px] font-medium mb-2">No party lists found</h3>
                                <p class="text-[12px] text-gray-500">
                                    @if($search)
                                        No party lists match your search criteria.
                                    @else
                                        No party lists found.
                                    @endif
                                </p>
                            </div>
                        @endif
