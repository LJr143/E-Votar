<div class="mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex space-x-2">
            ...
            <button
                ...
                <svg width="16" height="12" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21.5 1.5H1.5L9.5 10.96V17.5L13.5 19.5V10.96L21.5 1.5Z" stroke="#000000" stroke-width="2"
        ...
        <table class="min-w-full bg-white">
            ...
            <tr class="w-full bg-black text-white uppercase text-[11px] leading-normal">
                <th class="py-3 px-6 text-left rounded-tl-lg border-b border-gray-300">
                    <input type="checkbox" class="form-checkbox h-4 w-4 text-black" x-model="selectAll"
            ...
            <tr class="border-b border-gray-300 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-left">
                    <span class="px-2 py-1 text-sm rounded {{ $record->status === 'online' ? 'bg-green-500 text-white' : 'bg-red-500 text-white' }}">
                                {{ $record->status }}
                            </span>
                </td>
                <td class="py-3 px-6 text-left">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mt-4">
        ...
        <div class="flex items-center space-x-1 text-[10px] md:text-[11px] text-black">
            ...
            <button
                class="w-8 h-8 flex items-center justify-center bg-black text-white border border-gray-300 rounded-md hover:bg-gray-800">
                1
            </button>
            <button
                class="w-8 h-8 flex items-center justify-center bg-white text-gray-400 border border-gray-300 rounded-md hover:bg-gray-100">
                2
            </button>
            <button
                class="w-8 h-8 flex items-center justify-center bg-white text-gray-400 border border-gray-300 rounded-md hover:bg-gray-100">
