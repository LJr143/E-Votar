<div x-data="{ open: false }" x-cloak @deactivated-user.window="open = false">
    <!-- Trigger Button -->
        ...
        >
            ...
            <div class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    ...
                    <h2 class="text-sm font-semibold text-red-600">Deactivate User</h2>
                </div>
                <!-- Close Button (X) -->
            ...
            <p class="text-gray-700 mb-6 ml-5 text-xs text-left">Are you sure you want to deactivate this user?: {{ $user->first_name . ' ' . $user->middle_initial
  . ' ' . $user->last_name}}.</p>
