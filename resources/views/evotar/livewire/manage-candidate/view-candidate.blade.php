                        ...
                        @foreach($candidates as $candidate)
                            @if($candidate->election_positions->position->electionType->name == 'Student Council Election')
                                <div wire:key="candidate-{{ $candidate->id }}">
                                    <div class="bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] min-h-[320px]">
                                        ...
                                        <div class="flex justify-center items-center">
                                            ...
                                            <div class="relative inline-block">
                                                ...
                                                <button onclick="toggleDropdown(this)" class="ml-2 focus:outline-none">
                                                    <svg width="4" height="13" viewBox="0 0 4 18" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M3 2C3 1.44772 2.5523 1 2 1C1.4477 1 1 1.44772 1 2C1 2.55228 1.4477 3 2 3C2.5523 3 3 2.55228 3 2Z"
                                                            stroke="#3F3E44" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"/>
                                                        <path
                                                            d="M3 9C3 8.4477 2.5523 8 2 8C1.4477 8 1 8.4477 1 9C1 9.5523 1.4477 10 2 10C2.5523 10 3 9.5523 3 9Z"
                                                            stroke="#3F3E44" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"/>
                                                        <path
                                                            d="M3 16C3 15.4477 2.5523 15 2 15C1.4477 15 1 15.4477 1 16C1 16.5523 1.4477 17 2 17C2.5523 17 3 16.5523 3 16Z"
                                                            stroke="#3F3E44" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"/>
                                                    </svg>
                                                </button>
                                                ...
                                                <!-- Dropdown menu -->
                                                <div
                                                    class="hidden absolute left-full ml-2 mt-10 bg-white border border-gray-200 rounded shadow-lg w-28 z-50">
                                                    <ul class="py-1 text-sm text-gray-700">
                                                        <li>
                                                            <button
                                                                class="w-full text-left px-4 py-2 flex items-center space-x-2 hover:bg-gray-500 hover:text-white">
                                                                <!-- SVG Icon -->
                                                                <svg width="19" height="19" viewBox="0 0 25 25"
                                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <mask id="mask0_1784_2853" style="mask-type:alpha"
                                                        ...
                                                        <li>
                                                            <button
                                                                ...
                                                                <svg width="19" height="19" viewBox="0 0 25 25"
                                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <mask id="mask0_1784_1499" style="mask-type:alpha"
                                                                          maskUnits="userSpaceOnUse" x="0" y="0"
                                                                          width="25" height="25">
                                                                        <rect x="0.5" y="0.5" width="24" height="24"
                                                                              fill="#D9D9D9"/>
