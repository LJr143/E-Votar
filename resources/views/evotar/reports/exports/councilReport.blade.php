...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <th style="font-size: 12px; border: 1px solid black; padding: 5px; height: 30px; vertical-align: middle; text-align: left; background-color: #970707; font-weight:700; color: white">Council ID</th>
