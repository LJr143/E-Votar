@props(['name', 'tabindex' => -1, 'class' => '', 'placeholder' => '', 'icon_class' => '', 'svg_class' => '', 'lock_class' => ''])
...
>
    ...
    <input tabindex="{{ $tabindex }}"
           ...
           class="rounded border px-7 focus:ring-transparent text-xs h-7 border-gray-300 focus:border-[#61FFBD] active:border-[#61FFBD] hover:border-[#61FFBD] {{ ' '.$class }}"
           required>
    <span class="absolute top-1.5 left-0 px-2 {{ ' '.$icon_class }}  {{ ' '.$lock_class }}">
        <svg class="w-4 {{ ' '.$svg_class }}" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.6664 9.64941H4.38573C3.41681 9.64941 2.63135 10.4349 2.63135 11.4038V17.5442C2.63135 18.5131 3.41681 19.2985 4.38573 19.2985H16.6664C17.6354 19.2985 18.4208 18.5131 18.4208 17.5442V11.4038C18.4208 10.4349 17.6354 9.64941 16.6664 9.64941Z" stroke="#6B7280" stroke-width="1.75439" stroke-linecap="round" stroke-linejoin="round"/><path d="M6.14014 9.64864V6.13987C6.14014 4.97664 6.60223 3.86105 7.42476 3.03853C8.24728 2.216 9.36287 1.75391 10.5261 1.75391C11.6893 1.75391 12.8049 2.216 13.6274 3.03853C14.45 3.86105 14.9121 4.97664 14.9121 6.13987V9.64864" stroke="#6B7280" stroke-width="1.75439" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </span>
    <button type="button" class="absolute top-1.5 right-0 px-2 {{ ' '.$icon_class }}" @click="show = !show">
        <svg x-cloak
             x-show="show"
             x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
             class="w-4 h-4 text-green-400 {{ ' '.$svg_class }}"
