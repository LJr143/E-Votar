...
class ViewController extends Controller
{
    ...
    protected function validationRules(): array
    {
        return [
            ...
            'email' => 'required|string|email|max:255|unique:users,email|regex:/^[a-zA-Z0-9._%+-]+@usep\.edu\.ph$/',
            'phone_number' => 'required|string|max:25|unique:users,phone_number',
            'year_level' => 'required|string|max:25',
            'student_id' => 'required|string|max:255|regex:/^\d{4}-\d+$/',
    ...
    protected function validationMessages(): array
    {
        return [
            ...
            'email.regex' => 'The format should be (xxxxx@usep.edu.ph).',
